...
title: gulp学习资料
tags: gulp
category: web前端学习资料（转）
status: publish
summary: 本文是关于gulp构建工具的学习资料合集，转自https://github.com/Platform-CUF/use-gulp/blob/master/README.md。
-->
#gulp构建工具学习资料和demo

本项目的目地是搜集gulp构建工具的学习资料和公司实际项目相关的一些demo。
#### 快速上手
为了使大家更加快速的上手gulp，特别在demo目录列举了一些gulp构建demo 。demo中包含了使用gulp来构建**angularjs 项目** 和 **普通项目**。
...
为什么gulp比grunt快，可以参考[Grunt Vs Gulp - Beyond the Numbers](http://jaysoo.ca/2014/01/27/gruntjs-vs-gulpjs/) 。

#### 关于NodeJS流(stream)的概念
由于gulp是基于流的方式工作的，所以想要进一步深入gulp,我们需要学习NodeJs流。相关资料如下。
- 文章
